    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="background-color: var(--bd-green); color: white;">
                <h5 class="modal-title" id="storeSkillModalLabel"><i class="fas fa-plus me-2"></i> Add New Skill</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            
            <form id="storeSkillForm" action="{{ route('skills.store') }}" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="name" class="form-label fw-bold">Skill Name <span class="text-danger">*</span></label>
                        <input type="text" 
